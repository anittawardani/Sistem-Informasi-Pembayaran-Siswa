      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <?php
            $varquery  = mysqli_query($konek,"SELECT * FROM detail_tag_ujian WHERE id_detail_ujian='".$_GET['id']."'");
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="" method="post">
                    <input type="hidden" name="id_detail_ujian" value="<?php echo $varData['id_detail_ujian']; ?>" />
          ...
          if ($_SERVER['REQUEST_METHOD']=='POST') {
            ...
            if ($varNamaAngsuran=='' || $varJumlah=='') {
              ...
              $simpan=mysqli_query($konek,"UPDATE detail_tag_ujian SET nama_angsuran='$varNamaAngsuran', jumlah='$varJumlah' 
                WHERE id_detail_ujian='$varId'");
              if(!$simpan){
