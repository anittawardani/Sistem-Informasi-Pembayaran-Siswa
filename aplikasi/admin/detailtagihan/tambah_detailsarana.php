      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tambah Tagihan Sarana Prasarana</li>
          </ol>
          ...
          if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            $simpan = mysqli_query($konek,"INSERT INTO detail_tag_sarana(nama_angsuran,jumlah) VALUES ('$varNamaAngsuran','$varJumlah')");

            if(!$simpan) {
              echo "Simpan data Tagihan Sarana Prasarana Gagal!";
            }else{
              ?>
              <script>  
                  alert("Data Tagihan Sarana Prasarana Berhasil Disimpan");
